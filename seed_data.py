...
providers_data = [
    ...
    },
    {
        "firstName": "Carlos",
        "lastName": "Rivera",
        "email": "carlos@testsalon.com",
        "phone": "+1-555-0104",
    },
    {
        "firstName": "Lisa",
        "lastName": "Park",
        "email": "lisa@testsalon.com",
        "phone": "+1-555-0105",
    },
]
...
for prov in providers_data:
    ...
    if r.status_code == 201:
        ...
        print(
            f"Provider: {prov['firstName']} {prov['lastName']} -> ID {r.json()['id']}"
        )
...
for cust in customers_data:
    ...
    if r.status_code == 201:
        ...
        print(
            f"Customer: {cust['firstName']} {cust['lastName']} -> ID {r.json()['id']}"
        )
