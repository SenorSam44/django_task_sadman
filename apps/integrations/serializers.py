...
class ConnectSerializer(serializers.Serializer):
    ...
    password = serializers.CharField(required=True, write_only=True)  # Hide in responses
...
class AppointmentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Appointment
        fields = ['id', 'start_time', 'end_time', 'status', 'location', 'external_id', 'provider', 'customer', 'service']
